...
(function () {
  ...
  function mount() {
    ...
    if (vid && 'IntersectionObserver' in window) {
      // Bron pas laden zodra de kaart in beeld komt; scheelt ~5 MB per paginaweergave.
      var bron = vid.getAttribute('src');
      if (bron) { vid.removeAttribute('src'); vid.dataset.src = bron; }
